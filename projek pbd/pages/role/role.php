...
// ambil data role
$qRole = mysqli_query($conn, "SELECT idrole, nama_role FROM role ORDER BY idrole ASC");
?>
<!doctype html>
<html lang="id">
<head>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="mt-4 d-flex flex-column">
        ...
        <a href="../role/role.php" style="font-weight:700;"><i class="bi bi-shield-lock"></i><span>Role</span></a>
...
<div class="main">
    ...
    <a href="tambah_role.php" class="btn btn-primary mb-3">
        ...
        <table class="table table-hover align-middle">
            ...
            <?php while($r = mysqli_fetch_assoc($qRole)): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <a href="detail_role.php?id=<?= $r['idrole'] ?>" class="btn btn-sm btn-outline-primary">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="edit_role.php?id=<?= $r['idrole'] ?>" class="btn btn-sm btn-outline-warning">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="hapus_role.php?id=<?= $r['idrole'] ?>" class="btn btn-sm btn-outline-danger"
